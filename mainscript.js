...
(() => {
	...
	var O = e => {
		var i, t, l;
		(i = window.top) == null || i.postMessage(e, "https://lovable.dev"), (t = window.top) == null || t.postMessage(e, "https://gptengineer.app"), (l = window.top) == null || l.postMessage(e, "http://localhost:3000")
	};
	var nt = e => {
			let i = window.fetch;
